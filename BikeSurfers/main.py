...
class Game:
        ...
        if not self.game_started and not self.edicao_started:
            if button == glfw.MOUSE_BUTTON_LEFT and action == glfw.PRESS:
                ...
                if (center_x - tolerance_x <= mouse_x <= center_x + tolerance_x and 
                    ...
                    self.edicao_started = True  # Muda para o modo de jogo
    ...
    def bateu(self):
        ...
        if len(self.obstaculo.motos) > 0:
            for moto in self.obstaculo.motos:  # Itera sobre a lista de caminhões
        ...
        if len(self.obstaculo.carros) > 0:
            for carro in self.obstaculo.carros:  # Itera sobre a lista de caminhões
    ...
    def render_fim(self):
        ...
        self.derrota.draw()  # Desenha o menu
