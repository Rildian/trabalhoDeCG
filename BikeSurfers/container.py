...
class Container:
    vertices = [
        [-18, -8, -8],  # Frente inferior esquerda
        [18, -8, -8],   # Frente inferior direita
        [18, 8, -8],    # Frente superior direita
        [-18, 8, -8],   # Frente superior esquerda
        [-18, -8, 8],   # Trás inferior esquerda
        [18, -8, 8],    # Trás inferior direita
        [18, 8, 8],     # Trás superior direita
        [-18, 8, 8],    # Trás superior esquerda
    ]
